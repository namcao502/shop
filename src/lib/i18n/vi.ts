...
export const vi: Record<TranslationKey, string> = {
  ...
  "checkout.orderCreatedPayLater": "Don hang da duoc tao nhung khong the khoi tao thanh toan.",
  "checkout.goToOrder": "Den don hang de thanh toan.",
  ...
  "order.save": "Lưu",
  "order.pendingPayment": "Cho thanh toan",
  "order.showQR": "Hien thi ma QR",
  "order.payWithMomo": "Thanh toan qua MoMo",
  "order.loadingQR": "Dang tao ma QR...",
  "order.momoRedirecting": "Dang chuyen sang MoMo...",
